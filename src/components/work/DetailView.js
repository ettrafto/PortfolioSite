...
function DetailView({ selected, onClose }) {
  ...
  // --- Mobile detection (no extra deps) ---
...
const detailStyle = useMemo(() => {
  if (isMobile) {
    // centered full-screen-ish on mobile
    return {
      display: "block",
      position: "fixed",
  ...
  // desktop: anchor by insets; NO translate
  return {
    display: "block",
    position: "fixed",
    top: "7.5%",
      ...
      >
        ...
        <div className="detail-parent">
          <div className="detail-img-container">
            <img className="detail-img" src={project.thumbnail} alt="" />
          </div>
